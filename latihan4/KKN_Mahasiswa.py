...
mhs1 = Mhs('Wisnu', 'Teknik Informatika', 4)
mhs2 = Mhs('Abdi', 'Teknik Informatika', 4)
mhs3 = Mhs('Buana', 'Teknik Informatika', 4)
mhs_kkm = mahasiswa_kkm([mhs1, mhs2, mhs3])
Kkm = kkm('Jawa Barat, Indonesia', mhs_kkm)
